...
const ACTIVE_RING_GRADIENT =
  "linear-gradient(135deg, #FFA500, rgba(255,21,114,1), rgba(254,107,123,1))";
const SEEN_RING_COLOR = "rgba(197, 184, 187, 1)";
...
const StoryRow = () => {
  ...
  // State for open and close upload dialog
          ...
          {isLoading ? (
            ...
            <>
              ...
              >
                ...
                >
                  {userCurrentStory.story ? (
                    <Box
                      sx={{
                        width: 70,
                        height: 70,
                        borderRadius: "50%",
                        background: ACTIVE_RING_GRADIENT,
                        display: "flex",
                        alignItems: "center",
                    ...
                    <Box
                      sx={{
                        ...
                        height: 70,
                        borderRadius: "50%",
                        border: "2px dashed rgb(197, 184, 187)",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        boxSizing: "border-box",
                    ...
                    >
                      <AddIcon
                        sx={{ fontSize: 26, color: "rgba(94, 19, 33, 1)" }}
                      />
                    </Box>
                  )}
                  <Box
                ...
                <Typography fontSize="12px" fontWeight={500} mt={0.5} noWrap>
                  {userCurrentStory.story ? getUserHandle(user) : "Add story"}
                </Typography>
              </Box>
                  ...
                  >
                    <Box
                      sx={{
                        ...
                        height: 70,
                        borderRadius: "50%",
                        background: !author.isActive
                          ? ACTIVE_RING_GRADIENT
                          : SEEN_RING_COLOR,
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
