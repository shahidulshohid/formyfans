    ...
    try {
      ...
      if (attachment) {
        ...
        if (isAudio(attachment)) {
          folder = "voice";
          mediaType = "audio";
        } else if (attachment.type === "application/pdf" || !attachment.type.startsWith("image/") && !attachment.type.startsWith("video/") && !isAudio(attachment)) {
          folder = "docs";
          mediaType = "file";
        } else {
          mediaType = "image";
        ...
        const result = await uploadFile(attachment, folder);
        if (!result.success) {
