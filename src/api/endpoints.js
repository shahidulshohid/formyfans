...
export const POST_ENDPOINTS = {
  ...
  TAG_USERS_SEARCH: "posts/tag-users/search",
};
...
export const Notification_ENDPOINTS = {
  ...
  MARK_ALL_NEED: "notifications/mark-all-read",
};
...
export const DEAL = {
  ACCEPT: "deal/:dealId/accept",
  REJECT: "deal/:dealId/reject",
  RECEIVED_STARTED: "deal/received/started",
};

export const CAMPAIGN_ENDPOINTS = {
  SINGLE: "campaigns/:campaignId",
  LIKE: "campaigns/:campaignId/like",
  UNLIKE: "campaigns/:campaignId/unlike",
  LIKES: "campaigns/:campaignId/likes",
  COMMENTS: "campaigns/:campaignId/comments",
  SHARE: "campaigns/share",
};

export const BOOST_ENDPOINTS = {
  WEBSITE_CLICK: "boost/:boostId/website-click",
};

export const ANALYTICS_ENDPOINTS = {
  TRACK_IMPRESSION: "posts/impression",
  TRACK_PROFILE_VISIT: "posts/:postId/profile-visit",
  GET_POST_ANALYTICS: "posts/:postId/analytics",
};

export const LIVE_STREAM_ENDPOINTS = {
  LIST: "live-streams",
  CREATE: "live-streams",
  SINGLE: "live-streams/:streamId",
  TOKEN: "live-streams/:streamId/token",
  END: "live-streams/:streamId/end",
  COMMENTS: "live-streams/:streamId/comments",
  FANBUGS: "live-streams/:streamId/fanbugs",
  FANBUG_INTENT: "live-streams/:streamId/fanbugs/intent",
  FANBUG_CONFIRM: "live-streams/:streamId/fanbugs/confirm",
};
